...
const styles = StyleSheet.create({
  ...
  overs: { fontFamily: FONTS.family, fontSize: 11, color: COLORS.TEXT_MUTED, marginTop: 2 },
  liveDot: { width: 8, height: 8, borderRadius: 4, backgroundColor: COLORS.LIVE },
  right: { flexDirection: 'row', alignItems: 'baseline' },
  score: { fontFamily: FONTS.family, fontSize: 28, fontWeight: '900', color: COLORS.TEXT },
  wickets: { fontFamily: FONTS.family, fontSize: 18, fontWeight: '600', color: COLORS.TEXT_MUTED },
  target: { fontFamily: FONTS.family, fontSize: 11, fontWeight: '600', color: COLORS.ACCENT_LIGHT, position: 'absolute', right: 14, bottom: 4 },
});
